      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="px-2 sm:px-6 lg:px-8">
            {/* Heading */}
            <h2 className="text-xl text-center lg:text-left sm:text-4xl md:text-5xl font-bold mb-2 leading-tight">
            ...
            {/* Description */}
            <p className="text-xs text-center lg:text-left sm:text-lg md:text-xl xl:text-2xl text-gray-600 mb-5 lg:mb-10 leading-relaxed">
