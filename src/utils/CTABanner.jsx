      ...
      <div className="mx-auto max-w-7xl bg-primary px-3 py-14 sm:p-14">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="text-white text-center lg:text-left flex-1">
            <h2 className="text-xl sm:text-4xl md:text-5xl font-bold mb-4 leading-tight">
              TRUSTED, VERIFIED PROFESSIONALS
            </h2>
            <p className="text-xs sm:text-base md:text-lg lg:text-xl leading-relaxed">
              Home services booked through Right Hands are carried out by thoroughly
              vetted, experienced professionals, ensuring quality and reliability.
              Our providers are carefully selected and highly rated by customers like you.
            </p>
          </div>
        </div>
      </div>
