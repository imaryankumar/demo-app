    ...
    <section className="w-full px-2 py-12 md:py-16 lg:py-24">
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-center">
          ...
          <div
            className={`relative h-[300px] sm:h-[400px] md:h-[450px] lg:h-[500px] flex items-center justify-center lg:justify-end ${paddingTop}`}
          >
            <Image
              src={image}
              alt="Right Hands Apps"
              fill
              loading="lazy"
